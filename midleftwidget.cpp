...
QColor midLeftWidget::color = QColor(230, 230, 230);
QColor midLeftWidget::bgcolor = QColor(255, 255, 255, 100);


midLeftWidget::midLeftWidget(QWidget *parent) :
    baseWidget(parent),
    m_Swidget0(this),
    m_Swidget1(this),
    m_Swidget2(this),
...
void midLeftWidget::setBackgroundtransparent()
{
...
void midLeftWidget::setBackgroundnormal()
{
...
{
     midLeftWidget::bgcolor = QColor(255,255,255,value);
     update();
}

void midLeftWidget::initLayout()
{
    ...
    for(int i = 0; i < 5; i++)
    {
        ...
        connect(m_btn[i], SIGNAL(pressed()), this, SLOT(slot_changeButtonSelected()));
    }
...
void midLeftWidget::slot_changeButtonSelected()
{
   // qDebug() << "slot_changeButtonSelected";
   // qDebug() << index;
...
void midLeftWidget::resizeEvent(QResizeEvent *e)
{
