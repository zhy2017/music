...
void myWidget::setPixmap(const QPixmap &pix)
{
    m_localPix=pix;
    update();
}

void myWidget::setShowSingerBG(bool is)
{
    m_isShowSingerBG=is;
}

void myWidget::setCurrentIndex(int i)
{
    m_curindex=i;
    update();
}

void myWidget::clearBg()
{
    m_issetpix=false;
    m_localPix=QPixmap("");
    update();
...
void myWidget::setSkin(const QString &skin)
{
